...
def cvDrawBoxes(detections, img):
    ...
    #================================================================
    if len(detections) > 0:  
        						# At least 1 detection in the image and check detection presence in a frame  
    ...
    #=================================================================            	
        ...
        if len(fall_alert_list)!=0:
                ...
                # makes sure that alert is generated when there are atleast 0 frames which shows that a fall has been detected
...
def YOLO():
    ...
    url = "https://youtu.be/gACTozuIp_o?feature=shared"                 # Uncomment these lines for video from youtube
    video = pafy.new(url)
